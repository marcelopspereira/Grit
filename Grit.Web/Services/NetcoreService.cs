...
using static Grit.Web.MVC.Pages;
...
namespace Grit.Web.Services
{
    public class NetcoreService : INetcoreService
    {
        ...
        public Task<string> UploadFile(List<IFormFile> files, IHostingEnvironment env)
        {
            throw new NotImplementedException();
        }

        VMStock INetcoreService.GetStockByProductAndWarehouse(string productId, string warehouseId)
        {
            throw new NotImplementedException();
        }

        List<VMStock> INetcoreService.GetStockPerWarehouse()
        {
            throw new NotImplementedException();
        }
    }
